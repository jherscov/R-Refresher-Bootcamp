---
title: Portfolio Analysis- Practice
author: R package build
date: '2021-10-02'
slug: portfolio-analysis-practice
categories: []
tags: []
---
...
3. As a reference line, use abline() to include a horizontal line at h=1. Note that where the value of the ratio is larger than one, the Coca Cola Company outperforms Pepsico and vice versa.
...
# Compute the weights
mkt.cap.wts <- mkt.cap/sum(mkt.cap)
  
# Inspect summary statistics on weights
summary(mkt.cap.wts)  
...
```{r}
(1-0.5)*(1+1) #you need to double your money if you lose half of your original value.
```
...
APPLE <- getSymbols("AAPL", src= "yahoo",from = "2006-01-01", to ="2016-01-01",auto.assign = FALSE)[,6]
MSFT <- getSymbols("MSFT", src= "yahoo",from = "2006-01-01", to ="2016-01-01",auto.assign = FALSE)[,6]

prices <- head(cbind(APPLE,MSFT))
